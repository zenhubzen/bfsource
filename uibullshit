...
function Library:create(options)
	...
	local hideButton = core:object("ImageButton", {
		BackgroundTransparency = 1,
		Size = UDim2.fromOffset(18, 18),
		Position = UDim2.new(1, -32.5, 0, 9),
		Theme = {ImageColor3 = "StrongText"},
		Image = "http://www.roblox.com/asset/?id=11798512206",
		AnchorPoint = Vector2.new(1)
	})

	hideButton.MouseEnter:connect(function()
		hideButton:tween{ImageColor3 = Color3.fromRGB(255, 124, 142)}
	end)

	hideButton.MouseLeave:connect(function()
		hideButton:tween{ImageColor3 = Library.CurrentTheme.StrongText}
	end)

	hideButton.MouseButton1Click:connect(function()
  game.CoreGui.farts.Enabled = false
  -- Gui to Lua
-- Version: 3.2

-- Instances:

local ForOpenGui = Instance.new("ScreenGui")
...
ForOpenGui.Name = "ForOpenGui"
ForOpenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
ForOpenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ForOpenGui.ResetOnSpawn = false

Frame.Parent = ForOpenGui
Frame.BackgroundColor3 = Color3.fromRGB(30, 30, 35)
Frame.Position = UDim2.new(0.0875958949, 0, 0.139506176, 0)
...
OpenGui.Position = UDim2.new(-0.180557802, 0, -0.300964624, 0)
OpenGui.Size = UDim2.new(0, 74, 0, 87)
OpenGui.Font = Enum.Font.Gotham
OpenGui.Text = "R"
OpenGui.TextColor3 = Color3.fromRGB(70, 130, 180)
OpenGui.TextSize = 60.000
OpenGui.MouseButton1Click:connect(function()
	game.Players.LocalPlayer.PlayerGui.ForOpenGui:Destroy()
	game.CoreGui.farts.Enabled = true
	game.CoreGui.ScreenGui.Enabled = true
	game.CoreGui.fart.Enabled = true
end)
  game.CoreGui.ScreenGui.Enabled = false
  game.CoreGui.fart.Enabled = false
	end)
	...
	local status = core:object("TextLabel", {
		...
		Font = Enum.Font.Code,
		Text = "Version 4.3.8 | Press Delete For Hide Gui [DEL]",
...
creditsTab:credit{Name = "Copy Script Discord", Description = "Copy Server ID", Discord = "https://discord.gg/abPfGvP7Hk"}	
creditsTab:credit{Name = "Efes", Description = "Script/Discord Owner", Discord = "Toshi.#2667"}	
	...
	if setclipboard then
		...
		if options.V3rmillion then
			...
			local v3rmillion = v3rmillionContainer:object("ImageLabel", {
				Image = "http://www.roblox.com/asset/?id=85940386769",
...
function Library:textbox(options)
	options = self:set_defaults({
		Name = "Text Box",
		Placeholder = _G.Settings.AttackCooldown,
		Description = nil,
