...
local colors = {
	...
	outerBorder = Color3.fromRGB(196, 196, 196),
	innerBorder = Color3.fromRGB(196, 196, 196),
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/zenhubzen/test/main/newui"))()
...
local PlayerStatsSection1 = MainTab:CreateSection({
    Name = "",
	Side = "Left"
})


PlayerStatsSection1:AddLabel({
	Name = "Welcome To Zen Hub!",
	Flag = ""
})
...
MainSection:AddDropdown({
    ...
    List = {"Normal Mode","Fast Mode","No Quest","Near Farm Mode","Fruit Mastery Mode","Gun Mastery Mode",},
...
local coffe = MainTab:CreateSection({
		Name = "Auto Cofetti",
		Side = "Left"
	})
coffe:AddToggle({
    Name = "Auto Cofetti",
    Flag = "Auto_Cofetti",
	Value = _G.Settings.Auto_Cofetti,
    Callback = function(value)
        _G.Auto_Confetti = value    
		_G.Settings.Auto_Cofetti = value
		saveSettings()
        StopTween(_G.Auto_Confetti)
end
})
...
coffe:AddToggle({
    Name = "Auto Cofetti Hop",
    Flag = "Auto_Cofetti_Hop",
	Value = false,
    Callback = function(value)
   Hop()
end
...
local Mystic = MainTab:CreateSection({
		Name = "Mirage Island",
		Side = "Left"
	})
...
Mystic:AddToggle({
    Name = "Auto Mystic Island Hop",
    Flag = "Auto_Mystic_Island_Hop",
	Value = false,
    Callback = function(value)
Hop()
end
...
spawn(function()
game:GetService("RunService").RenderStepped:Connect(function()
	if _G.Extra_Fast_Attack == true then
