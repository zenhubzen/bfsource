...
Main:Seperator("Hearts Farm")
  
if World3 then
    Main:Toggle("Auto Farm Hearts [only for Max Lv]", _G.AutoFarmHearts, function(heartfarmf)
        _G.AutoFarmHearts = heartfarmf
    end)
end
            ...
            pcall(function()
                if Lv == 2450 then
                    if not World3 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
                    elseif World3 then
                        TP(CFrame.new(-916.222656, 17.1481285, -14638.8125, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268))
                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                if v.Name == "Candy Pirate [Lv. 2400]" or v.Name == "Snow Demon [Lv. 2425]" then
                                    repeat task.wait(0.001)
                                        ...
                                        MonFarm = v.Name
                                        Click()
                                    until not _G.AutoFarmHearts or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    end
...
spawn(function()
    ...
    Mirragecheck:Set('ðŸï¸ : Mirage Island is Spawning')
      ...
      Mirragecheck:Set('ðŸï¸ : Mirage Island Not Found âŒ')
    end
            end
        end)
end)
...
local url = "https://discord.com/api/webhooks/1083169808075477033/GmO1ReXiYVfBiS5YBh-44Rj-lfz3sNaQ84OA12-54Z5NdHtKnwhoUh2SWdWEcUkLZmxT" -- ur webhook url
local data = {
...
AutoMisc2:Dropdown("Fast Attack Mode", AttackList, function(adl)
...
_G.FastAttack = true
AutoMisc2:Toggle('Fast Attack', _G.FastAttack, function(famobile)
...
Combat3:Slider("Lock Bounty",1,25000000,750000,function(value)
	...
	Teleport:Toggle("Ctrl + Click = Tween",false,function(vu)
		getgenv().Enabled = vu -- false Ã Â¸â€ºÃ Â¸Â´Ã Â¸â€
...
Shop:Seperator("\\\\\  Valentines Shop  //")

--// Valentine Shop
Shop:Button("2X Exp 15min [x25 Hearts]", "", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "15minDouble")
end)
Shop:Button("2X Exp 30min [x50 Hearts]", "", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "30minDouble")
end)
Shop:Button("Race Reroll [x50 Hearts]", "", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "RaceReroll")
end)
Shop:Button("Kilo Fruit [x60 Hearts]", "", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "Kilo-Kilo")
end)
Shop:Button("Smoke Fruit [x155 Hearts]","", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "Smoke-Smoke")
end)
Shop:Button("Buddha Fruit [x700 Hearts]", "", function()
    game:GetService("ReplicatedStorage").Remotes.Celebration:InvokeServer("Purchase", "Buddha-Buddha")
end)
