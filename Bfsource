...
return Label1func
 ...
 --------------------------------------------------------------------
 local Library = Update:Window("ZEN");
 --------------------------------------------------------------------
...
Setting:Seperator("「 Credits 」")
    Setting:Label("Made By Toshi.#2667 & AiZen#0956")
...
Update:Notification("Hello, "  ..game.Players.LocalPlayer.DisplayName.. " Welcome To Zen Hub V4! What's new? | [+] New Color Ui [+] Improve all [+] Fix Some Bugs [+] Added New Function [+] Much More... ")
